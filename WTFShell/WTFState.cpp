...
using namespace WTF;
void WTFState::getWrinkleMesh(const WTFSetup& setup, int upsamplingTimes, bool isUseV1Term, bool isUseV2Term)
{
	Eigen::MatrixXd cutV;
	Eigen::MatrixXi cutF;
...
void WTFState::reinitializeWrinkleVaribles(const WTFSetup& setup)
{
	std::set<int> clampedVerts;
	clampedVerts.clear();
