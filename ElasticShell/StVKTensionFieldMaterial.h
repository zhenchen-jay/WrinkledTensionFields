...
/*
 * Tension field approximation of St. Venant-Kirchhoff linear material model whose energy density
...
class StVKTensionFieldMaterial : public ElasticShellMaterial
{
public:
